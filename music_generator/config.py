...
parser.add_argument("--conditioning", type=str, required=False, default="continuous_concat",
                    choices=["none", "continuous_concat"], help='Conditioning type')
parser.add_argument("--data_folder", type=str, default="../data/DEAM/pt_files")
parser.add_argument('--full_dataset', action="store_true",
                    help='Use DEAM-full dataset')
...
parser.add_argument('--gen_step', type=int, default=500,
...
if args.full_dataset:
    assert args.conditioning == "none" and not args.regression, "LPD-full has NaN features"
